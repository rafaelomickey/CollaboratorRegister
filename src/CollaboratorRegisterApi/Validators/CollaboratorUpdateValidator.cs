...
{
    public class CollaboratorUpdateValidator : AbstractValidator<CollaboratorUpdateRequest>
    {
        public CollaboratorUpdateValidator()
        {
            RuleFor(e => e.Id).NotNull().NotEmpty().NotEqual(0).WithMessage(string.Format(Resource.Required, Resource.Id));
